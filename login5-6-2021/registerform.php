    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
        <fieldset>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control"  type="text" name="userDescription" value="<?php if(isset($_POST['userDescription'])) echo $_POST['userDescription'];?>" rows="5" id="comment"></textarea>
                </div>

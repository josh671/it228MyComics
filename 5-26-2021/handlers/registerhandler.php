...
//check if form fields are EMPTY
    ...
    if(empty($userDescription)){ 
        array_push($Reg_error, "Please fill out a description"); 
    }
...
if(count($Reg_error) === 0){ 
        ...
        $query = "INSERT INTO `Authors` (`AuthorUserName`, `AuthorEmail`, `Password`, `AuthorDescription`) VALUES ('$userName', '$fullemail', '$safe_password', '$userDescription')";

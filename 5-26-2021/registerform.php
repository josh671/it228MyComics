    ...
    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="POST">
        <fieldset>
                ...
                <div class="form-group">
                    <label for="comment">Please leave a description about you or your comics:</label>
                    <textarea class="form-control"  maxlength="200"  type="text" name="userDescription" value="<?php if(isset($_POST['userDescription'])) echo $_POST['userDescription'];?>" rows="5" id="comment" placeholder="200 characters or less"></textarea>
                </div>
